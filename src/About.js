    ...
    <div className="about-page">
      <div className="about-container">
        <div className="about-grid">
          ...
          {/* Left Column: Image & Academic Card */}
          <div className="about-image-column">
            <div className="about-image">
              <img src={aboutImage} alt="Tomato Crop Advisory" />
            </div>

            {/* SKAUST Collaboration Card */}
            <div className="skaust-card">
              <div className="skaust-header">
                <div className="skaust-icon-badge">
                  <FaGraduationCap />
                </div>
                <div className="skaust-title-group">
                  <span className="skaust-verified">
                    <FaCheckCircle /> Official Academic Data
                  </span>
                  <h4>Collaborative Knowledge Partner</h4>
                </div>
              </div>
              <p>
                Our crop advisory datasets, disease management protocols, and seasonal guidelines are sourced in collaboration with <strong>SKAUST (Sher-e-Kashmir University of Agricultural Sciences and Technology)</strong> to ensure scientific accuracy for valley growers.
              </p>
            </div>
          </div>
          ...
          <div className="about-content">
            ...
            <h2>Kashmir Crop Advisory System</h2>
