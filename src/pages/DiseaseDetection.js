  ...
  return (
    <div className="disease-page">
      ...
      <div className="disease-card">
        ...
        <button
          className={`predict-btn ${!preview ? "disabled" : ""}`}
          onClick={handlePredict}
          disabled={loading || !preview}
        >
          {loading ? (
            <div className="loader-text">
              <span className="spinner-sm"></span> Analyzing Image...
            </div>
          ) : (
            <>
              <FaSearch />
                  ...
                  {advice ? (
                    ...
                    <>
                      ...
                      <p className="general-advice">
                        Remove infected leaves immediately, maintain proper field
                        sanitation, avoid overhead irrigation, ensure good air
                        circulation, follow crop rotation, and consult your local
